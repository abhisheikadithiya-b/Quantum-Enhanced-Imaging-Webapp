...
import { User, Shield, BriefcaseMedical, Calendar, Download, TrendingDown, Activity } from 'lucide-react'
          ...
          {activeTab === 'scans' && (
            <div className="space-y-4">
              {activePatient.scans.map((scan, idx) => (
                <div key={idx} className="bg-card border border-border rounded-xl p-5 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:shadow-md transition-all duration-300">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2.5 grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-1 text-[11px] font-medium border-t border-border/40 pt-2.5">
                        <div>
                          <span className="text-muted-foreground">AI Flag: </span>
                          <span className={scan.prediction.includes('Detected') ? 'text-red-500 font-semibold' : 'text-emerald-500'}>
                            {scan.prediction}
                          </span>
                        </div>
                        <div>
                  ...
                  <button
                    ...
                    className="w-full md:w-auto px-4 py-2 rounded-lg bg-accent text-accent-foreground font-semibold text-xs hover:opacity-90 active:scale-95 transition-all duration-200 flex items-center justify-center gap-1"
                  >
